package data_types.ResourceDemo.Examples
...
object OpeningMultipleFiles extends App {

  // TODO: Not sure how to get example to work

  /*

  def openFile(str: String): IO[File] = IO(File(str))
  def close(file: File): IO[Unit] = /* file.close() */ IO.unit
  def read(file: File): IO[Char] = IO.pure('a')
